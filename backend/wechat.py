...
SECRET = 'a53388b4af2e8c1cb64cd039698bbdcf'
TOKEN = '123456'
AES_KEY = 'GAkFaH7f0XNxApesenBn8BJqpaehNP8Y3x4fYyJl6PS'
# 实例化微信(公众号)客户端
...
def raw_reply(data):
    ...
    if msg.type == 'text':
        ...
        elif msg.content.lower() in ['666', '999', 'hello', 'world']:
            # 图文消息
        ...
        elif msg.content.lower() in ['0', '00', '000']:
            reply = create_reply('[Smart]\nhttp://chenpeng.wx.gsw945.com/index/', msg)
        elif msg.content.lower() in ['u', 'up', 'upload']:
            reply = create_reply('[Smart]\nhttp://chenpeng.wx.gsw945.com/upload-image/', msg)
        else:
